...
//        TabHost.TabSpec danhsach = tabHost.newTabSpec("Danh Sách");
//        caidat.setIndicator("Danh Sách", getResources().getDrawable(R.mipmap.ic_launcher));
//        Intent d = new Intent(this, UsersListActivity.class);
//        caidat.setContent(d);
